        ...
        <div class="">
            ...
            <div>
                ...
                <div className='flex justify-center'>
                    <a href="https://github.com/P4ver/alxCards" target="_blank" class="inline-block bg-slate-900 hover:bg-slate-700 text-white font-bold py-2 px-[60px] rounded-3xl mt-1">
